    ...
    async getAverages (req, res) {
        ...
        switch (averageType) {
            case Config.averageType.daily:
                logic.calculateDailyAverage(differenceInDays, dateFrom, dateTo, measurementType, ESN, res);
                break;
            case Config.averageType.monthly:
                logic.calculateMonthlyAverage(differenceInDays, dateFrom, dateTo, measurementType, ESN, res);
                break;
            case Config.averageType.yearly:
                logic.calculateYearlyAverage(dateFrom, dateTo, measurementType, ESN, res)
                break;
            default:
                break;
        }
